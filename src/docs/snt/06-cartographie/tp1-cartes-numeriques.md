...
!!! note "Instructions"
    ...
    3. Effectuez les mesutes suivantes :
        ...
        - Voyagez un peu en vous rendant au nord ouest du Canada. Trouvez un iceberg et mesurer sa superficie. Trouvez sur le Web celle de votre ville et comparez.
...
!!! danger "Attention"
    ...
    Avant de passer à la suite, appelez votre enseignant afin qu’il s’assure, en vous interrogeant, que vous avez bien réussi toutes les activités.
    Si vous pensez ne pas avoir tout fait, revenez en arrière et n’hésitez pas à expérimenter.
