...
!!! danger "Important avant de commencer"
    ...
    Pour réaliser ce projet dans de bonnes conditions, vous devez avoir réussi et compris les travaux pratiques suivants :
...
-   :material-upload:{ .lg .middle } **3. Envoi**
    ...
    Consignes pour l'envoi du travail.
...
-   :material-comment-question-outline:{ .lg .middle } **4. Questions fréquentes**
    ...
    [:octicons-arrow-right-24: Questions fréquentes](faq.md)    
